...
const wyzwanieDays: WyzwanieDay[] = [
  {
    ...
    numberBg: "bg-transparent border-2 border-black",
    titleBold:
...
const WyzwanieFaq = () => (
  <div className="flex flex-col items-center px-6 text-black py-12 lg:py-16">
    <div className="pt-[40px] lg:pt-[60px] bg-ada-magicPurple4 rounded-[24px] px-6 py-8 lg:px-10 lg:py-10 max-w-3xl w-full">
...
const WyzwanieTestimonials = () => (
  <MaxWithBgColorContainer bgColor="bg-ada-magicPink3">
    <div className="py-12 lg:py-16 px-4">
      <h2 className="text-[28px] lg:text-[42px] font-montserrat font-bold uppercase leading-[110%] text-center mb-10 text-black">
