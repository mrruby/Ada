  ...
  <div className="py-16 lg:py-20 px-4">
    <div className="mx-auto flex max-w-5xl flex-col items-center text-center lg:max-w-[50%]">
      ...
      <p className="max-w-4xl text-[18px] lg:text-[24px] leading-[150%] text-black">
        ...
        <span className="whitespace-nowrap">A tymczasem Twoja konkurencja już puszcza reklamy i zbiera klientów, którzy mogliby trafić do Ciebie.</span>
        <br /><br />
        <span className="font-bold">
...
const wyzwanieDays: WyzwanieDay[] = [
  {
    ...
    numberBg: "border-2 border-black bg-transparent",
    titleBold:
    ...
    <div className="relative">
      ...
      <div className="relative z-10 flex justify-center py-4">
        <Button
          ...
          variant="dark"
          sectionId={OFFER_SECTION_ID}
          text={<span className="font-anton font-normal uppercase text-ada-magicYellow">Sprawdzam</span>}
...
const WyzwanieFaq = () => (
  <div className="flex flex-col items-center px-6 text-black py-12 lg:py-16">
    <div className="pt-[40px] lg:pt-[60px] bg-ada-light-pink rounded-2xl px-6 py-8 lg:px-10 lg:py-12">
...
const WyzwanieTestimonials = () => (
  <MaxWithBgColorContainer bgColor="bg-ada-magicPink3">
    <div className="py-12 lg:py-16 px-4">
      <h2 className="text-[28px] lg:text-[42px] font-montserrat font-bold uppercase leading-[95%] text-center mb-10 text-black">
        ZOBACZ CO CZŁONKINIE{" "}
        <span className="text-ada-magicYellow">MAGIC</span><br />
  ...
  <MaxWithBgColorContainer bgColor="bg-ada-magicPink3">
    <div className="py-10 lg:py-14 px-4 text-center">
      ...
      <Button
        ...
        variant="dark"
        sectionId={OFFER_SECTION_ID}
        text={<span className="font-anton font-normal uppercase text-ada-magicYellow">DOŁĄCZAM</span>}
