...
export const ANDROMEDA_PAGE_TITLE = "Andromeda 2026 - Mini-kurs"
export const andromedaHeroBgColor = "bg-ada-magicYellow"

export const andromedaDescriptionBullets = [
...
export const andromedaBenefits = [
  {
...
export const andromedaHeroLeft = (
  <>
    ...
    <h1 className="text-[32px] lg:text-[48px] font-anton font-normal leading-[125%] text-black">
      ...
      dla swoich klientek - bez przepalania budżetów i nerwowego testowania na
      oślep.
    </h1>
  </>
)
