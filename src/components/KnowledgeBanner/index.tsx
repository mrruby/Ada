  ...
  return (
    <div className="flex px-2 flex-col items-center text-center text-ada-blue md:pb-[150px]">
        <div className="pt-[60px] lg:pt-[160px] z-0 pb-[30px]">
          ...
          <p className="lg:text-adaSubtitle lg:w-[900px] pt-[12px] font-medium leading-tight">Dobrze, że tutaj jesteś, bo… <br/>to miejsce, w którym znajdziesz dużo dobroci specjalnie dla Ciebie! </p>
        </div>
