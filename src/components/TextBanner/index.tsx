...
const TextBanner = ({
  ...
  return (
    <div className="py-6 px-4 lg:pt-[68px] lg:pb-[40px]" id="blog-posts" >
      <div className="text-ada-blue flex flex-col items-center " >
      <div className="flex flex-col items-center text-center max-w-[864px]">
        <p className="font-bold lg:h-[58px] text-adaTitle lg:text-adaBig text-ada-grey">{title}</p>
        <h2 className="px-6 text-adaTitle font-bold">{title2}</h2>
    ...
    {socials && 
        <div className="flex w-full justify-center items-center gap-3 mb-[80px]">
          <Link to="https://www.instagram.com/adapromis/">
            <StaticImage src={"../../images/instagram.svg"} alt="Ada Promis" placeholder="none" width={29} height={29}  />
          </Link>
          <Link to="https://www.facebook.com/WypadaNieWypada" className="ml-2">
            <StaticImage src={"../../images/facebook.svg"} alt="Ada Promis" placeholder="none" width={29} height={29}  />
          </Link>
          <Link to="https://adrianna.com.pl/">
            <StaticImage src={"../../images/website.svg"} alt="Ada Promis" placeholder="none" width={39} height={32}  />
          </Link>
        </div>   
    }
    </div>
