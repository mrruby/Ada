...
const Terms = (): JSX.Element => {
  return (
    <Container>
      ...
      <p className="mb-4">
        Jeżeli tutaj trafiłeś_aś, to niezawodny znak, że cenisz sobie
        transparentność marki. Doskonale to rozumiem, dlatego oddaję w Twoje
        ręce dokument, który wyjaśni Ci zasady funkcjonowania mojego sklepu oraz
        całego procesu zakupów.
      </p>
      <p className="mb-4">
        Tyle słowem wstępu, teraz czas na formalności. Na początek moje pełne
        dane rejestrowe jako administratora sklepu, sprzedawcy i usługodawcy:
        Dawid Urbas Get Bold z siedzibą w Chorzowie przy ul. Żołnierzy Września,
        nr 79/6, 41-500, NIP 6272725565.
      </p>
      <p className="mb-4">
        Poniżej znajdziesz regulamin, w którym zawarte zostały informacje m.in.
        o sposobie złożenia zamówienia prowadzącego do zawarcia umowy,
        szczegółach dotyczących realizacji zawartej umowy, formach dostawy i
        płatności dostępnych w sklepie, procedurze odstąpienia od umowy, czy
        postępowaniu reklamacyjnym.
      </p>
      <p className="mb-4">
        W razie jakichkolwiek uwag, pytań, wątpliwości, jestem do Twojej
        dyspozycji pod adresem adrianna@getbold.agency
      </p>
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          <span className="font-bold">Kupujący</span> – osoba fizyczna, osoba
          prawna lub ułomna osoba prawna,
        </li>
        <li>
          <span className="font-bold">Konsument</span> – osoba fizyczna,
          zawierająca ze Sprzedawcą umowę niezwiązaną z bezpośrednio z jej
          działalnością gospodarczą lub zawodową; Konsument jest również
          Kupującym,
        </li>
        <li>
          <span className="font-bold">POCK</span> – osoba fizyczna zawierająca
          ...
          Gospodarczej; POCK jest również Kupującym,
        </li>
        <li>
          <span className="font-bold">Regulamin</span> niniejszy regulamin,
          dostępny pod adresem https://www.getbold.agency/regulamin,
        </li>
        <li>
          <span className="font-bold">Sklep</span> sklep internetowy działający
          pod adresem https://ebook.adrianna.com.pl,
        </li>
        <li>
          <span className="font-bold">Sprzedawca</span> – Dawid Urbas Get Bold z
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Za pośrednictwem Sklepu, Sprzedawca zapewnia Kupującemu możliwość
          zawarcia umowy sprzedaży produktów fizycznych dostępnych w Sklepie,
          umowy o dostarczenie treści cyfrowych (e-booki, kursy on-line)
          opisanych na stronach Sklepu oraz umowy o udział w szkoleniu
          stacjonarnym lub umowy o przeprowadzenie konsultacji indywidualnej
          zgodnie z informacjami zawartymi w Sklepie.
        </li>
        <li>
          Regulamin określa zasady i warunki korzystania ze Sklepu, a także
          prawa i obowiązki Sprzedawcy i Kupujących.
        </li>
        <li>
          Do korzystania ze Sklepu oraz treści cyfrowych zakupionych za
        ...
        <li>
          W sytuacji, w której, korzystanie z treści cyfrowych wymagałoby
          spełnienia dodatkowych warunków technicznych, warunki te wskazane są w
          opisie treści cyfrowej w Sklepie.
        </li>
        <li>
          Kupujący nie może dokonać zakupu w Sklepie anonimowo ani pod
          pseudonimem.
        </li>
        <li>
          Zakazane jest podczas korzystania ze Sklepu dostarczanie treści o
          charakterze bezprawnym, w szczególności poprzez przesyłanie takich
          treści za pośrednictwem formularzy dostępnych w Sklepie.
        </li>
        <li>
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Za pośrednictwem Sklepu, Sprzedawca świadczy na rzecz Kupującego
          usługi drogą elektroniczną.
        </li>
        <li>
          Podstawową usługą świadczoną drogą elektroniczną na rzecz Kupującego
        ...
        <li>
          Usługi świadczone są drogą elektroniczną na rzecz Kupującego
          nieodpłatnie. Odpłatne są natomiast umowy sprzedaży, umowy o
          dostarczenie treści cyfrowych oraz umowy o udział w szkoleniu
          stacjonarnym i umowy o przeprowadzenie konsultacji zawierane za
          pośrednictwem Sklepu.
        </li>
        <li>
          W celu zapewnienia bezpieczeństwa Kupującemu i przekazu danych w
          związku z korzystaniem ze Sklepu, Sprzedawca podejmuje środki
        ...
        <li>
          Wszelkie reklamacje związane z funkcjonowaniem Sklepu, Kupujący może
          zgłaszać za pośrednictwem poczty elektronicznej na adres e-mail
          promis.adrianna@gmail.com. W reklamacji Kupujący powinien określić
          rodzaj i datę wystąpienia nieprawidłowości związanej z funkcjonowaniem
          Sklepu. Sprzedawca będzie rozpatrywać wszelkie reklamacje w terminie
          do 30 dni od otrzymania reklamacji i poinformuje Klienta o jej
      ...
      <ol className="list-decimal pl-4 py-2">
        ...
        <li>
          ...
          podanie danych niezbędnych do realizacji zamówienia. Na etapie
          składania zamówienia następuje również wybór sposobu dostawy
          zamówionych produktów oraz wybór metody płatności za zamówienie.
          Warunkiem złożenia zamówienia jest akceptacja Regulaminu, z którym
          Kupujący powinien uprzednio się zapoznać. W razie jakichkolwiek
          wątpliwości dotyczących Regulaminu, Kupujący może skontaktować się ze
          Sprzedawcą.
        </li>
        <li>
          Proces składania zamówienia kończy kliknięcie w przycisk finalizujący
          ...
          <ol className="list-decimal pl-4">
            ...
            <li>
              w przypadku produktów elektronicznych – umowa o dostarczenie
              treści cyfrowych,
            </li>
            <li>
              )w przypadku szkoleń stacjonarnych i konsultacji – umowa o
              świadczenie usług.
            </li>
          </ol>
        </li>
        <li>
          Jeżeli przedmiotem zamówienia są jednocześnie produkty różnego rodzaju
        ...
        <li>
          Jeżeli Kupujący wybrał przy składaniu zamówienia płatność on-line, po
          kliknięciu w przycisk finalizujący zamówienie zostanie przekierowany
          do bramki płatności obsługiwanej przez zewnętrznego operatora
          płatności celem dokonania płatności za zamówienie. Jeżeli Kupujący
          wybrał płatność przelewem bankowym, po kliknięciu w przycisk
          finalizujący zamówienie zostanie przekierowany na stronę Sklepu z
          potwierdzeniem zamówienia oraz instrukcją dokonania płatności. Zapłata
          za zamówienie powinna nastąpić w dniu zawarcia umowy.
        </li>
        <li>
        ...
        <li>
          Kupujący oświadcza, że wszelkie dane podane przez niego w formularzu
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Dostępne do wyboru sposobu dostawy zamówienia obejmującego produkty
          fizyczne opisane są na stronie Sklepu oraz prezentowane są Kupującemu
          na etapie składania zamówienia. Koszt dostawy zamówienia ponosi
          Kupujący, chyba że Sprzedawca na stronie Sklepu wskaże inaczej.
          Sprzedawca ma prawo zadecydować o podziale zamówienia na kilka
          oddzielnych przesyłek bez ponoszenia dodatkowych kosztów przez
          Kupującego.
        </li>
        <li>
          Dostępne metody płatności za zamówienie opisane są na stronie Sklepu
          oraz prezentowane są Kupującemu na etapie składania zamówienia.
        </li>
        <li>
          Płatności elektroniczne, w tym płatności kartą płatniczą, obsługiwane
          są przez Stripe.
        </li>
        <li>
          Jeżeli Kupujący poprosił o wystawienie faktury, zostanie ona doręczona
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Realizacja zamówienia obejmującego treści cyfrowe następuje poprzez
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Realizacja zamówienia dotyczącego konsultacji następuje poprzez
          zapewnienie Kupującemu możliwości odbycia ze Sprzedawcą indywidualnej
          konsultacji on-line przez czas wynikający ze złożonego zamówienia. Po
          złożeniu zamówienia dotyczącego konsultacji, Sprzedawca skontaktuje
          się z Kupującym w celu ustalenia szczegółów konsultacji, w
          szczególności terminu konsultacji.
        </li>
        <li>
          Terminy konsultacji ustalane są wspólnie przez Sprzedawcę i
          Kupującego. W przypadku konieczności zmiany terminu konsultacji,
          istnieje taka możliwość, z tym zastrzeżeniem, że wykupione godziny
          konsultacji muszą zostać wykorzystane w ciągu 365 dni od zawarcia
          umowy.
        </li>
        <li>
          Przed konsultacją może istnieć konieczność przekazania Sprzedawcy
          dodatkowych informacji, o której Sprzedawca poprosi za pośrednictwem
          poczty elektronicznej.
        </li>
        <li>
          Niewykorzystanie przez Kupującego wykupionych godzin konsultacji w
          ciągu 365 dniod zawarcia umowy, za wyjątkiem sytuacji, w której
          Kupujący skutecznie odstąpił od umowy albo doszło do rozwiązania umowy
          za porozumieniem stron, nie uprawnia Kupującego do zwrotu
          wynagrodzenia zapłaconego Sprzedawcy za zakupioną konsultację.
        </li>
        <li>
          Konsultacje realizowane są zawsze w wariancie jedno-godzinnym. Oznacza
          to, że Kupujący nie może dzielić wykupionej godziny konsultacji na
          więcej niż jedno spotkanie ze Sprzedawcą. Jeżeli konsultacja trwa
          mniej niż godzinę ze względu na okoliczności leżące po stronie
          Kupującego, niewykorzystany czas konsultacji przepada.
        </li>
      </ol>
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Konsument lub POCK, który zawarł ze Sprzedawcą umowę na odległość, ma
        ...
        <li>
          ...
          <ol className="list-decimal pl-4">
            ...
            <li>
              ...
              wyraźną zgodą Konsumenta lub POCK przed upływem terminu do
        ...
        <li>
          Chwilą rozpoczęcia spełniania świadczenia w przypadku treści cyfrowych
          jest doręczenie Kupującemu wiadomości e-mail z instrukcją pobrania lub
          uzyskania dostępu do treści cyfrowych.
        </li>
        <li>
          Aby odstąpić od umowy, Konsument lub POCK musi poinformować Sprzedawcę
        ...
        <li>
          Aby zachować termin do odstąpienia od umowy, wystarczy, aby Konsument
          lub POCK wysłał informację dotyczącą wykonania przysługującego
          Konsumentowi lub POCK prawa odstąpienia od umowy przed upływem terminu
          do odstąpienia od umowy.
        </li>
        <li>
          Konsument lub POCK ma obowiązek zwrócić produkt Sprzedawcy lub
          przekazać go osobie upoważnionej przez Sprzedawcę do odbioru
          niezwłocznie, jednak nie później niż 14 dni od dnia, w którym odstąpił
          od umowy, chyba że Sprzedawca zaproponował, że sam odbierze rzecz. Do
        ...
        <li>
          ...
          POCK wszystkie otrzymane od Konsumenta lub POCK płatności, w tym
          najtańszy dostępny w Sklepie koszt dostarczenia produktów (jeśli koszt
          pokrył Konsument) niezwłocznie, a w każdym przypadku nie później niż
          14 dni od dnia, w którym Sprzedawca został poinformowany o wykonaniu
          prawa odstąpienia od umowy. Zwrot płatności zostanie dokonany przy
          użyciu takich samych sposobów płatności, jakie zostały przez
          Konsumenta lub POCK użyte w pierwotnej transakcji, chyba że Konsument
          lub POCK wyraźnie zgodził się na inne rozwiązanie. W każdym przypadku
          Konsument lub POCK nie poniesie żadnych opłat w związku z formą zwrotu
          płatności.
        </li>
        <li>
          Jeżeli Sprzedawca nie zaproponował, że sam odbierze rzecz od
          Konsumenta lub POCK, może wstrzymać się ze zwrotem płatności
          otrzymanych od Konsumenta lub POCK do chwili otrzymania rzeczy z
          powrotem lub dostarczenia przez Konsumenta lub POCK dowodu jej
          odesłania, w zależności od tego, które zdarzenie nastąpi wcześniej.
        </li>
        <li>
          Konsument lub POCK ponosi odpowiedzialność za zmniejszenie wartości
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Sprzedawca ma obowiązek dostarczyć Kupującemu produkt oraz treść
          cyfrową wolną od wad, jak również wykonać usługę w sposób należyty, z
          zastrzeżeniem ust. 3 poniżej.
        </li>
        <li>
          Sprzedawca jest odpowiedzialny względem Kupującego, jeżeli sprzedany
        ...
        <li>
          Rękojmia za wady wyłączona jest w stosunku do Kupujących innych niż
          Konsument oraz POCK.
        </li>
        <li>
          Jeśli Kupujący stwierdzi wadę produktu, treści cyfrowej lub
          nienależyte wykonanej usługi powinien poinformować o tym Sprzedawcę,
          określając jednocześnie swoje roszczenia lub składając oświadczenie
          stosownej treści.
        </li>
        <li>
          Kupujący może kontaktować się ze Sprzedawcą zarówno pocztą tradycyjną,
          jak również pocztą elektroniczną.
        </li>
        <li>
          Sprzedawca ustosunkuje się do składanej przez Kupującego reklamacji w
        ...
        <li>
          Szczegóły dotyczące rękojmi Sprzedawcy za wady rzeczy sprzedanej
      ...
      <ol className="list-decimal pl-4 py-2">
        ...
        <li>
          Szczegóły związane z danymi osobowymi oraz plikami cookies opisane
          zostały w polityce prywatności dostępnej pod adresem
          ebook.adrianna.com.pl
        </li>
      </ol>
      ...
      <ol className="list-decimal pl-4 py-2">
        <li>
          Sprzedawca poucza niniejszym Kupującego, że treści dostępne na
          stronach Sklepu, treści cyfrowe dostępne w Sklepie, elementy produktów
          fizycznych (np. projekty graficzne), materiały przekazywane podczas
          konsultacji lub szkoleń mogą stanowić utwory w rozumieniu ustawy z
      ...
      <ol className="list-decimal pl-4 py-2">
        ...
        <li>
          ...
          konta użytkownika. W razie braku akceptacji nowego Regulaminu,
          Kupujący może nieodpłatnie usunąć swoje konto użytkownika.
        </li>
        <li>
          Wszelkie spory związane z umowami zawieranymi za pośrednictwem Sklepu
          będą rozpatrywane przez polski sąd powszechny właściwy ze względu na
        ...
        <li>
          Wszystkie archiwalne wersje Regulaminu dostępne są do ściągnięcia w
