...
const CustomBanner = ({
  ...
  return (
    <div className="flex px-2 xl:px-6 flex-col items-center lg:flex-row text-ada-blue relative min-h-[560px] max-w-[1280px] mx-auto">
      <div className={paragraphStyle}>
        <h1 className="text-adaTitle font-bold pb-8 lg:w-[704px]">
          {title}
        </h1>
        ...
        <div className="mt-[14px]">
          {actionButton && <Button type="button" text={btnText} url={btnUrl}  btnStyle="md:w-[344px]"/>}
        </div>
      </div>
